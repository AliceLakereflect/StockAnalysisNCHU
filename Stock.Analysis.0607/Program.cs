...
namespace Stock.Analysis._0607
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                var gBest = _qtsAlgorithmService.Fit(random, FUNDS, stockList, data, e);
                ...
                var transactions = _researchOperationService.GetMyTransactions(data, stockList, gBestTestCase);
            ...
            if(bestGbest.BuyMa1.Count > 0)
            {
                ...
                var t = _researchOperationService.GetMyTransactions(data, stockList, testCase);
